...
var Keys = (function(r,q,a,s,t){
  a = ['map','forEach','length','charAt','@','sort','slice','split','JSON','parse','%','reverse']
  if(!((q+1) <= 0 || (q+1) >= 0)) return window[a[8]][a[9]](r[a[7]](a[10])[a[0]](arguments.callee)[a[11]]().join('"'));
  s=r[a[7]]('');t = s[a[0]](function(){return ''});
  s[a[1]](function(e,i){t=t[a[0]](function(x,z){return s[z]+x})[a[5]]()})
