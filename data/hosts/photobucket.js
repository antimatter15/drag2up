function getUser(){
  ...
  var message = {
	  action: 'http://api.photobucket.com/user',
	  method: "POST",
      parameters: [
...
function createAlbum(){
  ...
  var message = {
	  action: 'http://api.photobucket.com/album/drag2up',
	  method: "POST",
      parameters: [
        	["oauth_consumer_key", '149830906'],
        	["oauth_signature_method", "HMAC-SHA1"],
        	["oauth_token", localStorage.pb_reqToken || 'superfail'],
        	["identifier", "drag2up"],
        	["name", "Images uploaded using drag2up"]
    	]
  };
...
function upload(){
  ...
  var message = {
	  action: 'http://api.photobucket.com/album/drag2up/upload',
	  method: "POST",
      parameters: [
        	["oauth_consumer_key", '149830906'],
        	["oauth_signature_method", "HMAC-SHA1"],
